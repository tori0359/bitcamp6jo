...
insert into admins (adno,name,id,pw1,pw2,cp,email,sex,pwa,pwfno,deptno) values (admins_seq.nextval,'홍길동','adad','1234','1234','010-1234-5678','asd@naver.com',1,'일진초',2,1);